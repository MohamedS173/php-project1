...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <h1 class="services_taital">Our <span class="text-warning">Goods</span></h1>
        </div>
        <div class="col-sm-12 mt-5">
            ...
            <table border="3" class="table table-bordered table-hover mt-5">
                                            ...
                                            <form action="/add-item" method="post" id="addForm" onsubmit="store(event)">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-select form-select-sm" name="items" aria-label=".form-select-sm example" id="items_select">
                                                        ...
                                                        @endforeach
                                                        <!-- <input type="hidden" name="user_id" data-user-id="{{ $data->id }}" id="myUser_id" value=""> -->
                                                    </select>
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="" class="text-dark">Quntity</label>
                                                    <input type="text" class="form-control" id="quntity-add" name="quantity" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                                </div>
                ...
                <tbody id="equipTableBody">
                    ...
                    <tr id="tab_{{$data->id}}">
                        ...
                        <td>
                            ...
                            <!-- <input type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#addquntityModal" onClick="changeUserId(this)" data-user-id="{{ $data->id }}" value="Edit"> -->
                ...
                <!-- Modal -->
                <div class="modal fade" id="addquntityModal" tabindex="-1" aria-labelledby="addquntityModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="/additem" id="additems_form" onsubmit="additem(event)" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="" class="text-dark">Quntity</label>
                                        <input type="text" class="form-control" id="quntity" name="quantity_change">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-outline-success">Save</button>
                ...
                <!-- Modal -->
                <div class="modal fade" id="takequntityModal" tabindex="-1" aria-labelledby="takequntityModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form action="/takeitem" id="takeitems_form" onsubmit="takeitem(event)" method="post">
                                    ...
                                    <!-- @method('post') -->
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="hidden" name="usert_id" data-user-id="{{ $data->id }}" id="myUsert_id" value="">

                                    <div class="form-group mb-3">
                                        <label for="" class="text-dark">Quntity</label>
                                        <input type="text" class="form-control" id="quntity_take" name="quantity_change">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-outline-success">Save</button>
